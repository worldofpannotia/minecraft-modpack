...
summon area_effect_cloud ^ ^0.7 ^0.15 {CustomName:'{"text":"Opened","color":"white"}',CustomNameVisible:1,Tags:["floating_message"],Radius:0f,Duration:30}
...
execute store result entity @s ArmorItems[3].tag.CustomModelData int 1 run scoreboard players get %opened Key
tag @s add opened
tag @s remove closed
