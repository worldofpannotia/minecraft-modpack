...
summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Glowing:1b,Small:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["egolden_apple_leaves","APT","EGoldenAppleLeaf"]}
