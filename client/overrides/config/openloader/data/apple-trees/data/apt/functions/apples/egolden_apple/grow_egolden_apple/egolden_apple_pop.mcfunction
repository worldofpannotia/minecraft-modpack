...
summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:0b,Fire:100,HasVisualFire:0b,Small:1b,Marker:0b,Invisible:0b,Health:1f,Tags:["grown_enchanted_golden_apple"],ArmorItems:[{},{},{},{id:"minecraft:enchanted_golden_apple",Count:1b}]}
