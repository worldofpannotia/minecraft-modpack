...
# Get Level
execute store result score %EnchantmentLevel eplus.temp run data get entity @s Inventory[{Slot:102b}].components."minecraft:enchantments".levels."enchantmentplus:soul_reserve" 5
