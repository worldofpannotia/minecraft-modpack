# Scoreboards
scoreboard objectives add eplus.damage_resisted minecraft.custom:damage_resisted
scoreboard objectives add eplus.deflect_cooldown dummy
...
scoreboard objectives add eplus.used_firework_rocket minecraft.used:minecraft.firework_rocket