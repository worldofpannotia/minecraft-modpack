...
# Called by:    name_formatting:check_bold_false
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.bold set value "{\"nbt\":\"Items[0].tag.NameFormatting.underlined\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"bold\":\"false\"}"
