...
# Called by:    name_formatting:check_gray
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.color set value "{\"nbt\":\"Items[0].tag.NameFormatting.OriginalName\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"color\":\"gray\"}"
