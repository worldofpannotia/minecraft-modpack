...
# Called by:    name_formatting:check_obfuscated_true
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.obfuscated set value "{\"nbt\":\"Items[0].tag.NameFormatting.strikethrough\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"obfuscated\":\"true\"}"
