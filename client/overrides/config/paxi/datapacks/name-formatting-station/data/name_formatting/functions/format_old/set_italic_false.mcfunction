...
# Called by:    name_formatting:check_italic_false
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.italic set value "{\"nbt\":\"Items[0].tag.NameFormatting.color\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"italic\":\"false\"}"
