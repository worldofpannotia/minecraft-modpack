...
execute unless entity @s[predicate=name_formatting:mainhand_book] unless data entity @s[scores={FormatName=511}] SelectedItem.tag.display.Name run tellraw @s {"text":"[ Requires a named item in the mainhand! ]","color":"red"}
execute unless entity @s[predicate=name_formatting:mainhand_book] unless data entity @s[scores={FormatName=511}] SelectedItem.tag.display.Name run scoreboard players set @s FormatName 99
...
execute if entity @s[predicate=name_formatting:mainhand_book] unless data entity @s[scores={FormatName=100..511}] Inventory[{Slot:-106b}].tag.display.Name run tellraw @s {"text":"[ Requires a named item in the offhand! ]","color":"red"}
execute if entity @s[predicate=name_formatting:mainhand_book] unless data entity @s[scores={FormatName=100..511}] Inventory[{Slot:-106b}].tag.display.Name run scoreboard players set @s FormatName 99
# checks for levels
...
execute if data entity @s[scores={FormatName=511}] Inventory[{Slot:-106b}].tag.NameFormat{merged:1} run tellraw @s ["",{"text":"[ Requires a formatted item in the offhand!","color":"red"},{"text":" ]","color":"red"}]
execute if data entity @s[scores={FormatName=511}] Inventory[{Slot:-106b}].tag.NameFormat{merged:1} run scoreboard players set @s FormatName 99
# checks for formatted item in offhand
execute unless data entity @s[scores={FormatName=511}] Inventory[{Slot:-106b}].tag.NameFormat run tellraw @s ["",{"text":"[ Requires a formatted item in the offhand!","color":"red"},{"text":" ]","color":"red"}]
execute unless data entity @s[scores={FormatName=511}] Inventory[{Slot:-106b}].tag.NameFormat run scoreboard players set @s FormatName 99
# checks for lore item in offhand
execute unless data entity @s[scores={FormatName=610}] Inventory[{Slot:-106b}].tag.display.Lore run tellraw @s ["",{"text":"[ Requires an item with Lore in the offhand!","color":"red"},{"text":" ]","color":"red"}]
execute unless data entity @s[scores={FormatName=610}] Inventory[{Slot:-106b}].tag.display.Lore run scoreboard players set @s FormatName 99
