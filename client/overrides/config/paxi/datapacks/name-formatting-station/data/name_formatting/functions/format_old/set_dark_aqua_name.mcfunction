...
# Called by:    name_formatting:check_dark_aqua
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.color set value "{\"nbt\":\"Items[0].tag.NameFormatting.OriginalName\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"color\":\"dark_aqua\"}"
