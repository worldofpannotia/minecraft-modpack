...
execute as @e[tag=ts_itemDetection] at @s if entity @e[type=minecraft:item,distance=..1,nbt={Item:{id:"minecraft:nether_star",count:1}}] run function thunder_shrine:initiate_storm
