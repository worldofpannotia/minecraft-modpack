...
cd afk-display;7z a -tzip ../afk-display.zip .;cd ..
...
cd more-effective-tools;7z a -tzip ../more-effective-tools.zip .;cd ..
...
cd vanillatweaks;7z a -tzip ../vanillatweaks.zip .;cd ..
...
cd xmarksthespot;7z a -tzip ../xmarksthespot.zip .;cd ..
