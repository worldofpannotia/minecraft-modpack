...
scoreboard players add @a[advancements={blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work={jungle=true}}] jungle_nitwit 1
scoreboard players add @a[advancements={blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work={swamp=true}}] swamp_nitwit 1
scoreboard players add @a[advancements={blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work={plains=true}}] plains_nitwit 1
scoreboard players add @a[advancements={blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work={desert=true}}] desert_nitwit 1
scoreboard players add @a[advancements={blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work={taiga=true}}] taiga_nitwit 1
scoreboard players add @a[advancements={blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work={snow=true}}] snow_nitwit 1
scoreboard players add @a[advancements={blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work={savanna=true}}] savanna_nitwit 1

advancement revoke @a only blackbirds_torture_chamber:stuff/make_youre_the_nitwit_work
