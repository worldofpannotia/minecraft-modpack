...
# Called by:    name_formatting:check_bold_true
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.bold set value "{\"nbt\":\"Items[0].tag.NameFormatting.underlined\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"bold\":\"true\"}"
