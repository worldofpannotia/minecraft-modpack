...
# Called by:    name_formatting:check_strikethrough_true
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.strikethrough set value "{\"nbt\":\"Items[0].tag.NameFormatting.bold\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"strikethrough\":\"true\"}"
