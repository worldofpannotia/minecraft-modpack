...
# Entity @s:    player
#
tellraw @s [{"text": "Offhand to Mainhand ","color": "gold"},{"text":"[Append]", "color": "yellow", "clickEvent": { "action": "run_command", "value": "/trigger FormatName set 500" }},{"text":" or ","color": "gold"},{"text":"[Prepend]", "color": "yellow", "clickEvent": { "action": "run_command", "value": "/trigger FormatName set 501" }}]
# append
