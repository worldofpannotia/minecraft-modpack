...
# Called by:    name_formatting:check_append_names
# Entity @s:    none
#
...
execute as @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=set_name] run loot replace entity @s weapon.mainhand loot name_formatting:append_names
