...
# Called by:    name_formatting:check_underlined_true
# Entity @s:    none
#
...
#
data modify block ~ ~ ~ Items[0].tag.NameFormatting.underlined set value "{\"nbt\":\"Items[0].tag.NameFormatting.italic\",\"block\":\"~ ~ ~\",\"interpret\":\"true\",\"underlined\":\"true\"}"
