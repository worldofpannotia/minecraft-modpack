...
tellraw @s [{"text":"", "clickEvent": { "action": "run_command", "value": "/trigger FormatName set 400" }},{"text":"[ ","color": "yellow"},{"text": "revert name formatting?: ", "color": "yellow"},{"nbt": "NameFormat.OriginalName", "storage": "name_formatting:item_data", "interpret": "true" },{"text":" ]","color": "yellow"}]