...
# Entity @s:    player
#
tellraw @s [{"text": "Offhand to Lore ","color": "gold"},{"text":"[Append]", "color": "yellow", "clickEvent": { "action": "run_command", "value": "/trigger FormatName set 600" }},{"text":" or ","color": "gold"},{"text":"[Prepend]", "color": "yellow", "clickEvent": { "action": "run_command", "value": "/trigger FormatName set 601" }}]
tellraw @s [{"text": "Remove Lore ","color": "gold"},{"text":"[Last]", "color": "yellow", "clickEvent": { "action": "run_command", "value": "/trigger FormatName set 602" }},{"text":" or ","color": "gold"},{"text":"[First]", "color": "yellow", "clickEvent": { "action": "run_command", "value": "/trigger FormatName set 603" }}]
# append
