...
execute as @a[advancements={blazeandcave:adventure/seafood_skewer=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={blazeandcave:biomes/chatterbox=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={blazeandcave:biomes/birdkeeper=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={blazeandcave:statistics/overpopulation=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={blazeandcave:mining/mitosis=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:mining/punching_bag=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:mining/truly_an_all_purpose_tool=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={minecraft:husbandry/uh_oh=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:mining/stink_bomb=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:mining/all_the_balls=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:mining/bouncy_beats=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:building/the_smell_of_rotten_eggs=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:building/cinnabar_island=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:animal/whole_horse=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:animal/counting_sheep=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:animal/fountain_of_youth=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:monsters/grim_neigh=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:monsters/lancelot=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:monsters/sands_the_skeleton=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:monsters/unwanted_passenger=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:monsters/ride_or_dry=true}] run scoreboard players add @s bac_advancements 1
#execute as @a[advancements={blazeandcave:monsters/jockey_jamboree=true}] run scoreboard players add @s bac_advancements 1
#execute as @a[advancements={blazeandcave:monsters/the_wicked_witch_of_the_west=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:weaponry/time_to_hunt=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:weaponry/spear_fishing=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:weaponry/toasted_marshmallow=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:weaponry/britney_spears=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:weaponry/hit_and_run=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:weaponry/arrow_of_ultimate_obliteration=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:weaponry/impiled=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:weaponry/death_star=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:biomes/welcome_to_neverland=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:biomes/equiangular_spiral=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:biomes/a_scute_off_the_old_shell=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:biomes/naughtylus=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:biomes/coralful_shell=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:biomes/submarine_fleet=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:biomes/20_leagues_under_the_sea=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:enchanting/classic_cartoon_comedy=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:enchanting/master_jouster=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:statistics/shell_testing=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:statistics/captain_nemo=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancements={blazeandcave:statistics/lord_helix=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:potion/water_balloon=true}] run scoreboard players add @s bac_advancements 1

execute as @a[advancements={blazeandcave:end/taking_the_scenic_route=true}] run scoreboard players add @s bac_advancements 1
