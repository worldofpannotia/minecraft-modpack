...
# Ready
execute if score @s eplus.dashing_delay matches 0 run title @s actionbar {translate:"notification.enchantmentplus.dashing.ready",fallback:"\u00A7ADashing is ready!"}
