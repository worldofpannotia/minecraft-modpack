...
execute as @e[type=armor_stand,tag=vwh_armor_stand,sort=nearest,limit=1] at @s align xyz run summon minecraft:area_effect_cloud ~0.5 ~1 ~0.5 {custom_particle:{type:"minecraft:heart"},ReapplicationDelay:10,Radius:0.5f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:200,WaitTime:0,Tags:["vwh_area_effect_cloud"]}
